...
#include "c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD.h"
...
static void initialize_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
static void initialize_params_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
static void enable_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
static void disable_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleS
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
static void set_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance,
   const mxArray *c5_st);
static void finalize_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
static void sf_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
static void initSimStructsc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
static void registerMessagesc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
...
static void c5_d_emlrt_marshallIn
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance,
   const mxArray *c5_b_delay1, const char_T *c5_identifier, real_T c5_y[15]);
static void c5_e_emlrt_marshallIn
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance,
   const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[15]);
...
static void c5_f_emlrt_marshallIn
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance,
   const mxArray *c5_ydelay, const char_T *c5_identifier, real_T c5_y[15]);
...
static uint8_T c5_l_emlrt_marshallIn
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance,
   const mxArray *c5_b_is_active_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD, const
  ...
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD = 0U;
}
  ...
  (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  c5_b_hoistedGlobal =
    chartInstance->c5_is_active_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
   ...
   const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD =
    ...
    "is_active_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleS(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance;
  chartInstance = (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_get_eml_resolved_functions_info
  (void)
{
   ...
   char_T *c5_identifier)
{
  ...
  c5_y = c5_m_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD);
  return c5_y;
}
   ...
   uint32_T c5_b)
{
  ...
  if (chartInstance->c5_ydelay_global_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'ydelay_global\' (#217) in the initialization routine of the chart.\n");
  }
...
void sf_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"ydelay\",},{M[4],M[0],T\"delay1\",S'l','i','p'{{M1x2[151 157],M[0],}}},{M[4],M[0],T\"i\",S'l','i','p'{{M1x2[183 184],M[0],}}},{M[8],M[0],T\"is_active_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
    ((SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct*)
     chartInstanceVar);
  initialize_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
    ((SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(void
  *chartInstanceVar)
{
  enable_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
    ((SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(void
  *chartInstanceVar)
{
  disable_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
    ((SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(void
  *chartInstanceVar)
{
  sf_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
    ((SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
    ((SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD();/* state var info */
...
extern void sf_internal_set_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
    ((SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(S);
}

static void sf_opaque_set_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(S, st);
}

static void sf_opaque_terminate_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
      ((SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
    ((SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(SimStruct *
  S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(SimStruct *S)
{
  SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance;
  chartInstance = (SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *)
    utMalloc(sizeof(SFc5_Copy_of_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD;
...
void c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_method_dispatcher.\n"
