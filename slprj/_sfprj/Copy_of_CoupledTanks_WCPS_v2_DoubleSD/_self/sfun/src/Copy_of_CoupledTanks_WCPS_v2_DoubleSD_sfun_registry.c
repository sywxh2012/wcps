...
{
  extern unsigned int
    sf_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Copy_of_CoupledTanks_WCPS_v2_DoubleSD") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Copy_of_CoupledTanks_WCPS_v2_DoubleSD") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_third_party_uses_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_get_eml_resolved_functions_info
...
extern unsigned int sf_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Copy_of_CoupledTanks_WCPS_v2_DoubleSD")) {
    return(sf_Copy_of_CoupledTanks_WCPS_v2_DoubleSD_method_dispatcher
...
extern void Copy_of_CoupledTanks_WCPS_v2_DoubleSD_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Copy_of_CoupledTanks_WCPS_v2_DoubleSD_terminator();
...
extern void Copy_of_CoupledTanks_WCPS_v2_DoubleSD_initializer(void);
extern void Copy_of_CoupledTanks_WCPS_v2_DoubleSD_register_exported_symbols
  (SimStruct* S);
extern void Copy_of_CoupledTanks_WCPS_v2_DoubleSD_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Copy_of_CoupledTanks_WCPS_v2_DoubleSD_register_exported_symbols(S);
}
