  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(932318306U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1511439833U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3969440592U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2370164356U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "hMRJT6cTi82mZE67U8NSnG") == 0) {
          extern mxArray
     ...
     case 3:
      {
        if (strcmp(aiChksum, "2NIAjjie1YPnu1FPYDmHBG") == 0) {
          extern mxArray
     ...
     case 6:
      {
        if (strcmp(aiChksum, "jqCYcrYXR02UBvBax37bNH") == 0) {
          extern mxArray
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "5nyiXhCMng0fDydm5ObgGF") == 0) {
          extern mxArray
     ...
     case 3:
      {
        if (strcmp(tpChksum, "SHRlsLnznTnhR9dWaB08BG") == 0) {
          extern mxArray
     ...
     case 6:
      {
        if (strcmp(tpChksum, "YOzJrhzgMBi2onSlFQE1DC") == 0) {
          extern mxArray
