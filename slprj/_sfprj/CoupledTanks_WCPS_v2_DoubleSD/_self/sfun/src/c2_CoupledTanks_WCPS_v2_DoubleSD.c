...
static void c2_o_emlrt_marshallIn
  (SFc2_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
   c2_struct_L0Sph11LhZyf9d1aXjl1TE *c2_y);
...
static void c2_s_emlrt_marshallIn
  (SFc2_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[505]);
  ...
  (SFc2_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  c2_struct_L0Sph11LhZyf9d1aXjl1TE c2_r0;
  ...
  (SFc2_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  int32_T c2_i16;
  real_T c2_ydelay[15];
  c2_struct_L0Sph11LhZyf9d1aXjl1TE c2_b_structure;
...
{
  const mxArray *c2_mxArrayOutData = NULL;
  c2_struct_L0Sph11LhZyf9d1aXjl1TE c2_u;
  const mxArray *c2_y = NULL;
  real_T c2_b_u;
  const mxArray *c2_b_y = NULL;
  real_T c2_c_u;
  ...
  chartInstance = (SFc2_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *)
    chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  c2_u = *(c2_struct_L0Sph11LhZyf9d1aXjl1TE *)c2_inData;
  c2_y = NULL;
  ...
  for (c2_i69 = 0; c2_i69 < 505; c2_i69++) {
    c2_f_u[c2_i69] = c2_u.delay1[c2_i69];
  }

  c2_f_y = NULL;
  sf_mex_assign(&c2_f_y, sf_mex_create("y", c2_f_u, 0, 0U, 1U, 0U, 2, 101, 5),
                FALSE);
   ...
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[505])
{
  real_T c2_dv11[505];
  int32_T c2_i73;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv11, 1, 0, 0U, 1, 0U, 2, 101,
                5);
  for (c2_i73 = 0; c2_i73 < 505; c2_i73++) {
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  *(c2_struct_L0Sph11LhZyf9d1aXjl1TE *)c2_outData = c2_y;
  sf_mex_destroy(&c2_mxArrayInData);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3688453337U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3691999693U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2454752897U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2417113002U);
}
...
mxArray *sf_c2_CoupledTanks_WCPS_v2_DoubleSD_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("hMRJT6cTi82mZE67U8NSnG");
...
static void mdlSetWorkWidths_c2_CoupledTanks_WCPS_v2_DoubleSD(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(548008928U));
  ssSetChecksum1(S,(2646385162U));
  ssSetChecksum2(S,(1173345573U));
  ssSetChecksum3(S,(3274657351U));
