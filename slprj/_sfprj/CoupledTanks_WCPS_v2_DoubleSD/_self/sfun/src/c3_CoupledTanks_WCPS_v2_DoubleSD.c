...
static void sf_c3_CoupledTanks_WCPS_v2_DoubleSD
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
static void c3_chartstep_c3_CoupledTanks_WCPS_v2_DoubleSD
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance);
...
static void c3_o_emlrt_marshallIn
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
   c3_struct_L0Sph11LhZyf9d1aXjl1TE *c3_y);
...
static void c3_s_emlrt_marshallIn
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[505]);
  ...
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  c3_struct_L0Sph11LhZyf9d1aXjl1TE c3_r0;
  ...
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  for (c3_i12 = 0; c3_i12 < 10; c3_i12++) {
    _SFD_DATA_RANGE_CHECK((*c3_yout)[c3_i12], 0U);
  }

  for (c3_i13 = 0; c3_i13 < 15; c3_i13++) {
    _SFD_DATA_RANGE_CHECK((*c3_ydelay)[c3_i13], 1U);
  }

  for (c3_i14 = 0; c3_i14 < 5; c3_i14++) {
    _SFD_DATA_RANGE_CHECK((*c3_yout_delay)[c3_i14], 2U);
  }

  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_CoupledTanks_WCPS_v2_DoubleSD(chartInstance);
  ...
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  int32_T c3_i16;
  real_T c3_ydelay[15];
  c3_struct_L0Sph11LhZyf9d1aXjl1TE c3_b_structure;
...
{
  const mxArray *c3_mxArrayOutData = NULL;
  c3_struct_L0Sph11LhZyf9d1aXjl1TE c3_u;
  const mxArray *c3_y = NULL;
  real_T c3_b_u;
  const mxArray *c3_b_y = NULL;
  real_T c3_c_u;
  ...
  chartInstance = (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *)
    chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  c3_u = *(c3_struct_L0Sph11LhZyf9d1aXjl1TE *)c3_inData;
  c3_y = NULL;
  ...
  for (c3_i69 = 0; c3_i69 < 505; c3_i69++) {
    c3_f_u[c3_i69] = c3_u.delay1[c3_i69];
  }

  c3_f_y = NULL;
  sf_mex_assign(&c3_f_y, sf_mex_create("y", c3_f_u, 0, 0U, 1U, 0U, 2, 101, 5),
                FALSE);
   ...
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[505])
{
  real_T c3_dv12[505];
  int32_T c3_i73;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv12, 1, 0, 0U, 1, 0U, 2, 101,
                5);
  for (c3_i73 = 0; c3_i73 < 505; c3_i73++) {
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  *(c3_struct_L0Sph11LhZyf9d1aXjl1TE *)c3_outData = c3_y;
  sf_mex_destroy(&c3_mxArrayInData);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(396779926U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1028158591U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(499211273U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2274446774U);
}
...
mxArray *sf_c3_CoupledTanks_WCPS_v2_DoubleSD_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("2NIAjjie1YPnu1FPYDmHBG");
...
static void mdlSetWorkWidths_c3_CoupledTanks_WCPS_v2_DoubleSD(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1805523252U));
  ssSetChecksum1(S,(1817431043U));
  ssSetChecksum2(S,(1209282442U));
  ssSetChecksum3(S,(641363896U));
